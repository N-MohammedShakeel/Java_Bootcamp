package Java_Bootcamp.AdvancedJava.JavaCryptographyArchitecture.Module_2; /**
 * TripleDESEncryption.java
 * Demonstrates Triple DES (DESede) encryption/decryption for strings using CBC mode and PKCS5Padding.
 * Scenario: Legacy system compatibility (more secure than DES but slower than AES).
...
public class TripleDESEncryption {
    ...
    // Decrypts a string using Triple DES
    ...
    // Generates a random IV (8 bytes for Triple DES)
    ...
    public static void main(String[] args) throws Exception {
        // 168-bit key (24 bytes for Triple DES)
        byte[] key = new byte[24];
        new SecureRandom().nextBytes(key);

        // String encryption/decryption
        String original = "Hello, Triple DES!";
